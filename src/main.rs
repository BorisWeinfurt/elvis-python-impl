...
use smoltcp::{
    ...
    phy::{
        Device, DeviceCapabilities, Loopback, Medium, PacketMeta, RxToken, TxToken,
    },
    socket::{
        tcp,
...
fn main() {
    ...
    let machine1 = MyCoolMachine::new(addr1, conn.get_left());
    ...
    let machine2 = MyCoolMachine::new(addr2, conn.get_right());
